...
The **Toyota Production System's** concept of **Andon** (stop-the-line quality control) mirrors the BT pattern of having a high-priority safety/quality subtree that can halt normal operations, which also appears in the subsumption architecture.
