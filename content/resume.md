...
- Engineering Team Leadership (10-30 engineers)
- Talent Acquisition & Development
- Process Optimization & Cross-functional Collaboration
- Technical Strategy
- Performance Management
- Mentoring & Career Development
- Startup Leadership & Founding Experience
...
CGPA: 9, First Class Distinction
...
Comprehensive technical book covering 40+ search algorithms across 7 categories including AI search, graph algorithms, and text matching. Features practical Python implementations, visualizations, and real-world applications. Covers advanced topics from basic linear search to complex algorithms like A*, Monte Carlo Tree Search, and Ant Colony Optimization.

---

## PATENTS

1. **18060,274:** Processing Techniques for Fast and Accurate Identification of Application Screens Using Optical Character Recognition

2. **18/307,280:** Cross-Application Walkthrough Guides from Desktop App to Desktop App, Desktop App to Browser and Browser to Desktop App

3. **18478,379:** System and Method for Detecting a Change in a Context of an Application

4. **18/454,118:** System and Method for Detecting a Change in Context of an Application Using Subsections

5. **18/398,544:** System and Method of Creating a Shadow Representation of the User Interface for Faster UI Element Retrieval
